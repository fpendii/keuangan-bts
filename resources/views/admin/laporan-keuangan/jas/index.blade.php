                                    ...
                                    @foreach ($transaksi as $item)
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                <!-- Tombol Cetak Struk -->
                                                <a target="_blank" href="{{ url('download/invoice/'.$page. '/' . $item->id_pesanan_jas) }}"
                                                    class="btn btn-secondary btn-sm">
                                                    <i class="fa fa-print"></i>
                                                </a>
                                                <!-- Tombol Edit -->
                                                <a href="{{ url('admin/order/jas/edit/' . $item->id_pesanan_jas) }}"
                                                    class="btn btn-warning btn-sm">
                                                    <i class="fa fa-pencil-alt"></i>
                                                </a>
                                                <!-- Tombol Hapus -->
                                                <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                                    data-bs-target="#deleteModal{{ $item->id_pesanan_jas }}">
                                                    <i class="fa fa-trash"></i>
                                                </button>

                                                <!-- Modal -->
                                                <div class="modal fade" id="deleteModal{{ $item->id_pesanan_jas }}"
                                                    tabindex="-1"
                                                    aria-labelledby="deleteModalLabel{{ $item->id_pesanan_jas }}"
                                                    aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title"
                                                                    id="deleteModalLabel{{ $item->id_pesanan_jas }}">
                                                                    Konfirmasi
                                                                    Hapus</h5>
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary"
                                                                    data-bs-dismiss="modal">Batal</button>
                                                                <form
                                                                    action="{{ url('admin/order/jas/hapus/' . $item->id_pesanan_jas) }}"
