            ...
            <div class="col-lg-4 col-md-6 order-1 order-lg-2">
                <div class="card h-100">
                    <div class="card-header pb-0">
                        <h6>Uang Kas</h6>
                        <p class="text-sm">
                            <i class="fa  {{ $totalPendapatanBulanIni > 0 ? 'fa-arrow-up text-success' : 'fa-arrow-down text-danger' }}"
                                aria-hidden="true"></i>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                <span class="text-xs font-weight-bold">
                                                    Rp. {{ number_format($item->total_harga) }} </span>
                                            </td>
                                            <td class="align-middle text-center">
                                                <!-- Tombol Cetak Struk -->
                                                <a target="_blank" href="{{ url('download/invoice/'.$page. '/' . $item->id_pesanan_bimbel) }}"
                                                    class="btn btn-secondary btn-sm">
                                                    <i class="fa fa-print"></i>
                                                </a>

                                                <!-- Tombol Edit -->
                                                <a href="{{ url('admin/order/bimbel/edit/' . $item->id_pesanan_bimbel) }}"
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary"
                                                                    data-bs-dismiss="modal">Batal</button>
                                                                <form
                                                                    action="{{ url('admin/order/bimbel/hapus/' . $item->id_pesanan_bimbel) }}"
