                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                <span class="text-xs font-weight-bold">
                                                    {{ number_format($item->harga_jual) }} </span>
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                            ...
                                            <td class="align-middle text-center">
                                                <!-- Tombol Cetak Struk -->
                                                <a target="_blank" href="{{ url('download/invoice/'.$page. '/' . $item->id_pesanan_servis) }}"
                                                ...
                                                <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                                    data-bs-target="#deleteModal{{ $item->id_pesanan_servis }}">
                                                    <i class="fa fa-trash"></i>
                                                </button>

                                                <!-- Modal -->
                                                <div class="modal fade" id="deleteModal{{ $item->id_pesanan_servis }}"
                                                    tabindex="-1"
                                                    aria-labelledby="deleteModalLabel{{ $item->id_pesanan_servis }}"
                                                    aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title"
                                                                    id="deleteModalLabel{{ $item->id_pesanan_servis }}">
                                                                    Konfirmasi
                                                                    Hapus</h5>
